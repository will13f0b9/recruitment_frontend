        ...
        <v-card-text>
          ...
          <v-row>
            <v-col cols="12" sm="6" md="4">
              <v-text-field v-model="user.name" clearable label="Nome" outlined shaped></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="4">
              <v-text-field v-model="user.email" clearable label="email" outlined shaped></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="4">
              <v-text-field v-model="user.cpf" clearable label="cpf" outlined shaped></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="4">
              <v-select
                outlined
          ...
          <v-row>
            ...
            <v-col cols="12" sm="12" md="12" v-if="pathFile">
              <iframe style="width: 100%" height="500px" :src="pathFile"></iframe>
            </v-col>
          </v-row>
        </v-card-text>
        <v-card-actions>
          <v-btn block class="white--text" color="green accent-4" @click="saveChanges()">Salvar</v-btn>
        </v-card-actions>
      </v-card>
    </v-container>
  </v-app>
